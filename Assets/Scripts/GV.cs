...
public class GV {
    ...
    public static float ZoomBounceIn(float progress)
    {
        float k = 1.2f;
        float h = 703f / 990f;
        float a = -0.2f / Mathf.Pow(h - 1f, 2f);
        if (progress <= 0f)
            return 0f;
        else if (progress >= 1f)
            return 1f;
    ...
    public static float ZoomBounceOut(float progress)
    {
        float k = 1.2f;
        float h = 287f / 990f;
        float a = -0.2f / Mathf.Pow(-h, 2f);
        if (progress <= 0f)
            return 1f;
        else if (progress >= 1f)
            return 0f;

...
public class GV {
    ...
    public static readonly Vector2 cloudSingleScreenAltitudeRange = new Vector2(-1f, 11f);
    public static readonly Vector2 cloudSingleScreenTravelRange = new Vector2(-20f, 20f); //x value is background x value past which a cloud will respawn on right; y value is background x value where cloud will respawn
